...
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente` (
  ...
  `Veículo_idVeículo` INT NULL,
  PRIMARY KEY (`idCliente`, `Veículo_idVeículo`),
  UNIQUE INDEX `CPF_UNIQUE` (`CPF` ASC) VISIBLE,
  UNIQUE INDEX `Telefone_UNIQUE` (`Telefone` ASC) VISIBLE,
  INDEX `fk_Cliente_Veículo1_idx` (`Veículo_idVeículo` ASC) VISIBLE,
  UNIQUE INDEX `Veículo_idVeículo_UNIQUE` (`Veículo_idVeículo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Veículo` (
  ...
  `Condições do veículo` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Equipe de mecânicos` (
  ...
  PRIMARY KEY (`idEquipe de mecânicos`, `Veículo_idVeículo`, `Mecânico_idMecânico`),
  INDEX `fk_Equipe de mecânicos_Veículo1_idx` (`Veículo_idVeículo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Serviço` (
  ...
  `Equipe de mecânicos_Veículo_idVeículo` INT NOT NULL,
  `Equipe de mecânicos_Mecânico_idMecânico` INT NOT NULL,
  PRIMARY KEY (`idServiço`, `Equipe de mecânicos_idEquipe de mecânicos`, `Equipe de mecânicos_Veículo_idVeículo`, `Equipe de mecânicos_Mecânico_idMecânico`),
  INDEX `fk_Serviço_Equipe de mecânicos1_idx` (`Equipe de mecânicos_idEquipe de mecânicos` ASC, `Equipe de mecânicos_Veículo_idVeículo` ASC, `Equipe de mecânicos_Mecânico_idMecânico` ASC) VISIBLE,
  CONSTRAINT `fk_Serviço_Equipe de mecânicos1`
    FOREIGN KEY (`Equipe de mecânicos_idEquipe de mecânicos` , `Equipe de mecânicos_Veículo_idVeículo` , `Equipe de mecânicos_Mecânico_idMecânico`)
    REFERENCES `mydb`.`Equipe de mecânicos` (`idEquipe de mecânicos` , `Veículo_idVeículo` , `Mecânico_idMecânico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`OS` (
  ...
  `Valor` VARCHAR(45) NOT NULL,
  `Autorização Cliente` VARCHAR(45) NULL,
  `Serviço_idServiço` INT NOT NULL,
  `Serviço_Equipe de mecânicos_idEquipe de mecânicos` INT NOT NULL,
  `Serviço_Equipe de mecânicos_Veículo_idVeículo` INT NOT NULL,
  `Serviço_Equipe de mecânicos_Mecânico_idMecânico` INT NOT NULL,
  PRIMARY KEY (`idOS`, `Serviço_idServiço`, `Serviço_Equipe de mecânicos_idEquipe de mecânicos`, `Serviço_Equipe de mecânicos_Veículo_idVeículo`, `Serviço_Equipe de mecânicos_Mecânico_idMecânico`),
  UNIQUE INDEX `Valor_UNIQUE` (`Valor` ASC) VISIBLE,
  INDEX `fk_OS_Serviço1_idx` (`Serviço_idServiço` ASC, `Serviço_Equipe de mecânicos_idEquipe de mecânicos` ASC, `Serviço_Equipe de mecânicos_Veículo_idVeículo` ASC, `Serviço_Equipe de mecânicos_Mecânico_idMecânico` ASC) VISIBLE,
  CONSTRAINT `fk_OS_Serviço1`
    FOREIGN KEY (`Serviço_idServiço` , `Serviço_Equipe de mecânicos_idEquipe de mecânicos` , `Serviço_Equipe de mecânicos_Veículo_idVeículo` , `Serviço_Equipe de mecânicos_Mecânico_idMecânico`)
    REFERENCES `mydb`.`Serviço` (`idServiço` , `Equipe de mecânicos_idEquipe de mecânicos` , `Equipe de mecânicos_Veículo_idVeículo` , `Equipe de mecânicos_Mecânico_idMecânico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tabela de preços - Mão de Obra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tabela de preços - Mão de Obra` (
  `idtabela de preços - Mão de Obra` INT NOT NULL,
  `Especialidade` VARCHAR(45) NULL,
  `Valor` VARCHAR(45) NULL,
  `OS_Serviço_Equipe de mecânicos_Mecânico_idMecânico` INT NOT NULL,
  PRIMARY KEY (`idtabela de preços - Mão de Obra`, `OS_Serviço_Equipe de mecânicos_Mecânico_idMecânico`),
  INDEX `fk_tabela de preços - Mão de Obra_OS1_idx` (`OS_Serviço_Equipe de mecânicos_Mecânico_idMecânico` ASC) VISIBLE,
  CONSTRAINT `fk_tabela de preços - Mão de Obra_OS1`
    FOREIGN KEY (`OS_Serviço_Equipe de mecânicos_Mecânico_idMecânico`)
    REFERENCES `mydb`.`OS` (`Serviço_Equipe de mecânicos_Mecânico_idMecânico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Tabela de preços - Peças`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Tabela de preços - Peças` (
  `idTabela de preços - Peças` INT NOT NULL,
  `Quantidade` VARCHAR(45) NULL,
  `Valor` VARCHAR(45) NULL,
  `OS_idOS` INT NOT NULL,
  PRIMARY KEY (`idTabela de preços - Peças`, `OS_idOS`),
  INDEX `fk_Tabela de preços - Peças_OS1_idx` (`OS_idOS` ASC) VISIBLE,
  CONSTRAINT `fk_Tabela de preços - Peças_OS1`
    FOREIGN KEY (`OS_idOS`)
